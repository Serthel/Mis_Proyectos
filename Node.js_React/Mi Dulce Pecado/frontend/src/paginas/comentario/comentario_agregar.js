...
function ComentarioAgregar() {
    ...
    function comentarioInsertar() {
        ...
        console.log(comentarioinsertar)
        ...
        axios.post(`/api/comentario/agregar`, comentarioinsertar, config).then(res => {
                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <div className="mb-12">
                            ...
                            <button type="button" onClick={comentarioInsertar} className="btn btn-success">Agregar</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default ComentarioAgregar;