...
function Carritocompra_Borrar(id)
{    
    //const navegar = useNavigate()

    function carritocompraRefrescar()
    {
        //navegar('/')
        window.location.href="/carritocompra_listar";
    }
    ...
    //********************************************************************************
        ...
        axios.delete(`/api/carrito_compra/borrar/${id}`, config)
        .then(() => this.setState({ status: 'Borrado Exitoso' }));
        
        carritocompraRefrescar()
...
export default Carritocompra_Borrar;