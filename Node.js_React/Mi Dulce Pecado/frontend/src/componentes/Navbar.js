            ...
            <div className="container text-light">
                <div className="w-100 d-flex justify-content-between">
                    <div>
                        ...
                        <a className="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">322-xxx-xxxx</a>
                    </div>
                    <div>
                        <a className="text-light" href="https://fb.com" target="_blank" rel="sponsored"><i className="fab fa-facebook-f fa-sm fa-fw me-2" /></a>
